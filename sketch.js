...
function draw() {
    ...
    if(gamestate == "play") {
        ...
        if(frameCount%1000==0 ||  ufoGrp.velocityY>=15) {
            ufoGrp.velocityY = ufoGrp.velocityY+2;
        }

        if(frameCount%1000==0 ||  starGrp.velocityY>=15) {
            starGrp.velocityY = ufoGrp.velocityY+1;
        }
